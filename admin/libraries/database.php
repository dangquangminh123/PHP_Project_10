...
function db_insert_multiple($table, $data)
{
    global $conn;
    ...
    $arrayKeyFirst = array_key_first($data);
    $firstData = $data[$arrayKeyFirst];
    $fields = "(" . implode(", ", array_keys($firstData)) . ")";
    ...
    $valueInsert = implode(', ', $valueInsert);
    $sql = "INSERT INTO {$table} {$fields} VALUES {$valueInsert}";
