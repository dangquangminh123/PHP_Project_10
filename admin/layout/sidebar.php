<div id="sidebar" class="fl-left">
    <ul id="sidebar-menu">
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?mod=pages&action=AddPage" title="" class="nav-link">Thêm mới</a>
                </li>
                <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?mod=posts&action=AddPost" title="" class="nav-link">Thêm mới bài viết</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=posts&action=AddCategories" title="" class="nav-link">Thêm danh mục bài
                        viết</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="?mod=posts&action=indexCategory" title="" class="nav-link">Danh mục bài viết</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?mod=products&action=AddProduct" title="" class="nav-link">Thêm mới sản phẩm</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=products&action=index" title="" class="nav-link">Danh sách sản phẩm</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=products&action=AddCategories" title="" class="nav-link">Thêm danh mục sản phẩm</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=products&action=indexCategory" title="" class="nav-link">Danh mục sản phẩm</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
